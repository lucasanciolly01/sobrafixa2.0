      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600">
            Comece grátis e turbine quando precisar.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="rounded-3xl border border-gray-200 p-8 hover:border-purple-200 transition-colors">
            ...
            <Link
              href="/register"
              className="block w-full py-3 rounded-xl bg-gray-100 text-center font-bold text-gray-900 hover:bg-gray-200"
            >
              Começar Grátis
            </Link>
          </div>
          ...
          <div className="relative rounded-3xl bg-gray-900 p-8 text-white shadow-2xl transform md:-translate-y-4">
            ...
            <div className="my-4">
              <span className="text-4xl font-bold">R$ 19,90</span>/mês
            </div>
            ...
            <Link
              href="/register"
              className="block w-full py-3 rounded-xl bg-linear-to-r from-primary to-secondary text-center font-bold hover:opacity-90"
            >
              Testar Premium
            </Link>
          </div>
          ...
          <div className="rounded-3xl border border-gray-200 p-8 hover:border-purple-200 transition-colors">
            ...
            <div className="my-4">
              <span className="text-4xl font-bold">R$ 49,90</span>/mês
            </div>
            <ul className="space-y-3 mb-8 text-sm text-gray-600">
              {["Gestão PJ e PF", "Fluxo de caixa", "Relatórios contábeis"].map(
                (item) => (
                  <li key={item} className="flex gap-3">
                    <Check className="text-green-500 w-5 h-5" /> {item}
                  </li>
            ...
            <Link
              href="/contact"
              className="block w-full py-3 rounded-xl border-2 border-gray-100 text-center font-bold text-gray-900 hover:border-gray-200"
            >
              Falar com Consultor
            </Link>
          </div>
